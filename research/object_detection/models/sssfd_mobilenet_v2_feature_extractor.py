...
class SSSFDMobileNetV2FeatureExtractor(ssd_meta_arch.SSDFeatureExtractor):
  ...
  def __init__(self,
    ...
    """MobileNetV2 Feature Extractor for SSSFD Models.
       Very similar to the feature extractor for SSD Models
    ...
    Args:
      ...
      override_base_feature_extractor_hyperparams: Whether to override
        ...
        `conv_hyperparams_fn`.
    """
    super(SSSFDMobileNetV2FeatureExtractor, self).__init__(
