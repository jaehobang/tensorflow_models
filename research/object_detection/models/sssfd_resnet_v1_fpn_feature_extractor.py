...
class _SSSFDResnetV1FpnFeatureExtractor(ssd_meta_arch.SSDFeatureExtractor):
  """SSSFD FPN feature extractor based on Resnet v1 architecture."""
  ...
  def __init__(self,
    ...
    """
    super(_SSSFDResnetV1FpnFeatureExtractor, self).__init__(
...
class SSSFDResnet50V1FpnFeatureExtractor(_SSSFDResnetV1FpnFeatureExtractor):
  ...
  def __init__(self,
    ...
    Args:
      ...
      override_base_feature_extractor_hyperparams: Whether to override
        ...
        `conv_hyperparams_fn`.
    """
    super(SSSFDResnet50V1FpnFeatureExtractor, self).__init__(
        is_training, depth_multiplier, min_depth, pad_to_multiple,
...
class SSSFDResnet101V1FpnFeatureExtractor(_SSSFDResnetV1FpnFeatureExtractor):
  ...
  def __init__(self,
    ...
    Args:
      ...
      override_base_feature_extractor_hyperparams: Whether to override
        ...
        `conv_hyperparams_fn`.
    """
    super(SSSFDResnet101V1FpnFeatureExtractor, self).__init__(
        is_training, depth_multiplier, min_depth, pad_to_multiple,
...
class SSSFDResnet152V1FpnFeatureExtractor(_SSSFDResnetV1FpnFeatureExtractor):
  ...
  def __init__(self,
    ...
    Args:
      ...
      override_base_feature_extractor_hyperparams: Whether to override
        ...
        `conv_hyperparams_fn`.
    """
    super(SSSFDResnet152V1FpnFeatureExtractor, self).__init__(
        is_training, depth_multiplier, min_depth, pad_to_multiple,
