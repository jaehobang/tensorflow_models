...
class FddbDetectionEvaluator(object_detection_evaluation.DetectionEvaluator):
  """Class to evaluate FDDB detection metrics."""
  ...
  def __init__(self,
    ...
    Args:
      ...
      all_metrics_per_category: Whether to include all the summary metrics for
        ...
        your mldash.
    """
    super(FddbDetectionEvaluator, self).__init__(categories)
